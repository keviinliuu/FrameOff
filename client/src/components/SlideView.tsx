                                ...
                                {votedFor === 'IMAGE1' ? (
                                    <div className='flex h-96 items-end'>
                                        ...
                                        <div
                                            ...
                                            style={{ height: image1BarSize }}></div>
                                    </div>
                                ) : (
                                    <div className='flex h-96 items-end'>
                            ...
                            <div>
                                {votedFor === 'IMAGE2' ? (
                                    <div className='flex h-96 items-end'>
                                        <div
                                            className={`w-6 bg-fushcia`}
                                            style={{ height: image2BarSize }}></div>
                                            
                                        <div className='absolute top-0 right-0 flex h-96 w-96 items-center justify-center border-4 border-fushcia bg-fuchsia-500 bg-opacity-50'>
                                            <p className='text-main text-xl text-moonbeam'>
                                    ...
                                    <div className='flex h-96 items-end'>
                                        ...
                                        <div className='absolute top-0 right-0 flex h-96 w-96 items-center justify-center bg-slate bg-opacity-50'>
                                            <p className='text-main text-xl text-moonbeam'>
                                                {votesImage2} votes, {votesPercent2}%
                                            </p>
                                        </div>
